...
export function Logo({ size = 'md' }: { size?: LogoSize }) {
  ...
  return (
    ...
    >
      ...
      <rect x="2" y="2" width="508" height="508" rx="100" stroke="#27272a" strokeWidth="4" />
      <rect x="96" y="280" width="80" height="120" rx="14" fill="#71717a" />
      <rect x="216" y="200" width="80" height="200" rx="14" fill="#71717a" />
      <rect x="336" y="120" width="80" height="280" rx="14" fill="#34d399" />
    </svg>
  )
}
...
export function LogoWithWordmark({ size = 'md' }: { size?: LogoSize }) {
  return (
    <div className="flex items-center gap-2">
      <Logo size={size} />
      <span className={`font-semibold text-zinc-100 ${textSizeMap[size]}`}>AgentInsight AI</span>
    </div>
  )
}
